...
namespace Snippet.Migrations
{
    ...
    [Migration("20210823101048_Added Name Column On CodeSnnipet")]
    partial class AddedNameColumnOnCodeSnnipet
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Snippet.Categories.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Snippet.CodeSnippets.CodeSnippet", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Snippet.Topics.Topic", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Snippet.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Snippet.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Snippet.CodeSnippets.CodeSnippet", b =>
                {
                    b.HasOne("Snippet.Categories.Category", "Category")
                        .WithMany()
                        .HasForeignKey("CategoryId");

                    b.HasOne("Snippet.Topics.Topic", "Topic")
