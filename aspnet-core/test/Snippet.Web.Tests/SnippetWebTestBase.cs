...
{
    public abstract class SnippetWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static SnippetWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(SnippetWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<SnippetDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<SnippetDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<SnippetDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<SnippetDbContext, Task<T>> func)
        {
            T result;
